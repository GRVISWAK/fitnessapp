    ...
    <div className="navbar">
      ...
      <div className="nav-center">
        <ul className="nav-menu">
         <li>
          <Link to="/workouts" onClick={(e) => handleProtectedLinkClick(e, "/workouts")}>🫵 For You</Link>
          </li>
          <li>
            <Link to="/workouts" onClick={(e) => handleProtectedLinkClick(e, "/workouts")}>🏋️‍♂️ Workouts</Link>
          </li>
          <li>
